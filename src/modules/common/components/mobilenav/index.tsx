...
const MobileNav = ({isCollapse, toggleMobileNav,scrollToSection}:MobileNavProps) => {
    ...
    return(
        <div className={clsx("fixed z-50 bg-theme transition-all md:w-[50vw] w-[80vw] duration-500 right-0 h-screen lg:hidden flex flex-col gap-8 p-8 border-l rounded-l-md border-gray-400 justify-start items-start",{
