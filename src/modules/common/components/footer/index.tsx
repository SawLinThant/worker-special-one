...
const Footer = () => {
  return (
    <footer className="h-full px-8 py-2 bg-theme">
      ...
      <div className="w-full h-full py-4 text-white border-t border-white"><p className="text-center">Copyright© 2022 Shwe Lan Chaung. All rights reserved.</p></div>
    </footer>
  );
};
